  ...
  return (
    <main className="bg-[#0a0807] text-[#e8dfd1] min-h-screen overflow-x-hidden" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <section ref={heroRef} className="relative h-[100svh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-end px-12 lg:px-24 pb-28 max-w-4xl">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.4, delay: 0.5, ease: [0.22, 1, 0.36, 1] }}
            className="text-[clamp(3rem,7vw,7rem)] leading-[0.95] tracking-[-0.02em]"
            style={{ fontFamily: DISPLAY, fontWeight: 400 }}
          >
            A color suite for
            <br />
            <em className="italic text-orange-200/95" style={{ fontWeight: 300 }}>photographers.</em>
          </motion.h1>
          <motion.p
          ...
          >
            Eight hand-graded LUTs and a real-time browser editor. Each grade is
            built against twenty reference frames, tested on calibrated paper,
            and shipped only when the print survives. No render queue, no
            subscription, no costume.
          </motion.p>
        </div>
